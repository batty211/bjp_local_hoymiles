...
- `FR-20a` daily energy ของวันเดียวกันต้องคงค่าสุดท้ายที่ไม่ใช่ศูนย์ไว้ได้ข้าม
  HA restart/reload และต้อง reset เมื่อข้ามวันตาม timezone ของ HA
...
- ผู้ใช้เพิ่ม sensor ของ integration เข้า Home Assistant Energy Dashboard ได้
- ผู้ใช้เห็น cumulative grid import/export, solar production, solar
  self-consumption และ total home consumption
