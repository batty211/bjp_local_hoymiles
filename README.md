...
ตัวอย่างนี้ใช้ `energy-date-selection` ของ Home Assistant ร่วมกับ custom card
`Energy Custom Graph` เพื่อเลือกวันหรือช่วงเวลาได้จริง และยังอ้าง sensor ที่
integration สร้างให้แล้วทั้งหมด

ถ้าจะใช้กราฟส่วนล่างแบบในตัวอย่าง ให้เพิ่ม custom Lovelace resource ของ
`Energy Custom Graph` ผ่าน HACS หรือ manual install ก่อน
