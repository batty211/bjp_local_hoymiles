...
ตัวอย่างนี้ใช้ `energy-date-selection` ของ Home Assistant ร่วมกับ core
...
snapshot ภายใน coordinator หากมีค่าก่อนหน้าใน meter serial เดียวกัน เพื่อให้
